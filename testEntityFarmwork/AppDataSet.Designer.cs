    ...
    public partial class commentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[comment] ([content_text], [time], [author], [post_id], [parent" +
                ...
                "content_text, time, author, post_id, parent_id FROM comment WHERE (id = SCOPE_ID" +
                "ENTITY())";
...
SELECT id, content_text, time, author, post_id, parent_id FROM comment WHERE (id = @id)";
        ...
        public virtual int Fill(AppDataSet.commentDataTable dataTable) {
        ...
        public virtual AppDataSet.commentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AppDataSet.commentDataTable dataTable = new AppDataSet.commentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AppDataSet.commentDataTable dataTable) {
